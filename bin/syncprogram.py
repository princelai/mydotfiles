...
subprocess.run('yaourt -Qqtn >! ../txt/yaourt.txt',shell=True,executable='/usr/bin/zsh')
subprocess.run('pip freeze >! ../txt/pip.txt',shell=True,executable='/usr/bin/zsh')
subprocess.run('conda list --export >! ../txt/conda.txt',shell=True,executable='/usr/bin/zsh')
